...
def load_problem(name):
    from learning_tsp.problems import TSP, TSPSL
    problem = {
        'tsp': TSP,
        'tspsl': TSPSL
        # 'cvrp': CVRP,
...
def load_model(path, epoch=None, extra_logging=False):
    from learning_tsp.nets.attention_model import AttentionModel
    from learning_tsp.nets.nar_model import NARModel
    from learning_tsp.nets.encoders.gat_encoder import GraphAttentionEncoder
    from learning_tsp.nets.encoders.gnn_encoder import GNNEncoder
    from learning_tsp.nets.encoders.mlp_encoder import MLPEncoder
